    ...
    <div class="row g-0">
        <div class="col-md-2 d-flex flex-column p-3 text-white bg-dark" style=" height: inherit; min-height: 100vh;">
            ...
            <ul class="nav nav-pills flex-column mb-auto">
                <li class="nav-item">
                    <a href="mproject" class="nav-link text-white active"><i class="bi bi-bank2 me-2"></i>  HOME</a>
                </li>
                <li class="nav-item"></li>
                    <a href="notif" class="nav-link text-white"><i class="bi bi-toggles2 me-2"></i>  MASTER PROJECT</a>
                </li>
                <li class="nav-item"></li>
